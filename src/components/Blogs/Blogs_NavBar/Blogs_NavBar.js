...
import NavBar_Pages from './NavBar_Pages'
import SignUp_Buttonprops from './SignUp_Button/SignUp_Buttonprops'
import Login_Buttonprops from './Login_Button/Login_Buttonprops'
...
const Blogs_NavBar = () => {
    ...
    return (
        <>
            <div className="Navbar w-full shadow-md	 h-24 max-md:h-20  flex justify-center items-center gap-72 max-xl:gap-60 max-lg:gap-32 max-md:gap-20 xl:h-40 xl:gap-80 overflow-hidden	max-sm:h-40 max-sm:block max-sm:w-full	"
                style={NavBarStyle}>
                <Logo_Navbar />
