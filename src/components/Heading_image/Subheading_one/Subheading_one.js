  ...
  return (
    <>
      <div className="subheading_one_container flex  items-center gap-3   emax-sm:absolute  max-sm:top-fulls  max-sm:w-3/5 ">
        ...
        <div
          className="subheading_one leading-normal not-italic text-xl max-lg:text-base max-md:text-sm max-md:leading-normal max-sm:text-sm max-gv:leading-normal max-gv:text-xs  "
          style={SubHeadingOne}
        >
