...
const Article_Card_3 = ({ articleDisplay }) => {
  return (
    <>
      <div className="articl_card_3_container ">
        <div className="article_card_3 flex justify-center items-center my-10 mb-20 2xl:container 2xl:mx-auto  max-xl:flex-wrap max-md:grid ">
          ...
          <Article_Card_3_3 />
          <div
            className="article_card_1_4 max-xl:w-107 max-xl:flex  xl:justify-center max-fl:w-80 articleDisplay"
            style={articleDisplay}
          >
            <Article_Card_3_4 />
          </div>
        </div>
